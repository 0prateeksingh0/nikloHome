        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-6 md:mt-8 lg:mt-12 px-2 md:px-4 lg:px-0">
            <div className="bg-white rounded-lg shadow-lg p-6 md:p-8 lg:p-10 max-w-2xl mx-auto text-center">
              <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 bg-[#886a4e] rounded-full flex items-center justify-center mx-auto mb-4 md:mb-6">
                <svg className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                </svg>
              </div>
              <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-[#886a4e] mb-3 md:mb-4">Contact – Turkey Office</h3>
