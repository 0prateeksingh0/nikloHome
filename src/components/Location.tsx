                ...
                <div className="bg-white rounded-xl shadow-xl p-6 md:p-8">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center">
                      ...
                      <span className="text-gray-700">{t('villas.feature1')}</span>
                    </div>
                    <div className="flex items-center">
                      <div className="w-2 h-2 bg-orange-500 rounded-full mr-3"></div>
                      <span className="text-gray-700">{t('villas.feature2')}</span>
                    </div>
                    <div className="flex items-center">
                      <div className="w-2 h-2 bg-orange-500 rounded-full mr-3"></div>
                      <span className="text-gray-700">{t('villas.feature3')}</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12 md:mb-16">
            ...
            <div className="bg-white rounded-xl shadow-xl p-4 md:p-6 border border-gray-100 h-[400px] md:h-[500px] flex flex-col">
              <div className="text-center mb-4">
                <div className="w-12 h-12 md:w-16 md:h-16 bg-gradient-to-br from-orange-500 to-orange-600 rounded-full flex items-center justify-center mx-auto mb-3 shadow-lg">
              ...
              <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <Link 
                  to="/contact"
                  className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl p-4 cursor-pointer hover:from-orange-100 hover:to-orange-200 transition-all duration-300 group block border border-orange-200"
                >
                  <h4 className="text-base font-bold text-gray-900 mb-3 flex items-center">
                    <div className="w-8 h-8 bg-orange-500 rounded-lg flex items-center justify-center mr-2">
                      <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <svg className="w-4 h-4 ml-2 text-orange-500 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
                  </h4>
                  <div className="text-gray-700 space-y-2 text-sm">
                    <div className="flex items-center">
                      <span className="font-semibold text-gray-900 mr-2 min-w-[60px]">{t('location.phone')}</span>
                      <a href="tel:02842145566" className="text-orange-600 hover:text-orange-700 transition-colors font-medium">0284 214 55 66</a>
                    </div>
                    <div className="flex items-center">
                      <span className="font-semibold text-gray-900 mr-2 min-w-[60px]">{t('location.mobile')}</span>
              ...
              <div className="mt-4 flex justify-center">
                <Link 
                  to="/contact"
                  className="inline-flex items-center justify-center px-6 py-2 bg-orange-500 text-white font-semibold rounded-lg hover:bg-orange-600 transition-colors shadow-lg hover:shadow-xl text-sm"
                >
